...
@Getter
public class MonitorCambiado extends DomainEvent {
    ...
    public MonitorCambiado(MonitorId monitorId, Nombre nombre, Identificacion identificacion, AcuerdoDeConfidencialidad acuerdoDeConfidencialidad) {
        super("co.com.sofka.challengeDDD.MonitorCambiado");
